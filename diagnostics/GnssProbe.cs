...
namespace WwanProbe.Diagnostics
{
    ...
    // Diagnostic only. Do not start a second native fix session alongside Windows.
    public sealed class GnssProbe : IDisposable
    {
        ...
        public GnssProbe(string devicePath)
        {
